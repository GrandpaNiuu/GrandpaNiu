...
| blackmatrix7 Privacy Lite | remote_rule | 否 | 否 | 95 | 低 | 低 | 低 | 低 | 低 | upstream-public-rule | 是 | manual-review | trust=blackmatrix7/ios_rule_script; rule-hints=privacy,tracker; disabled=2026-06-13: source failed for 2 confirmed checks, last_error=HTTP 404 HTTP 404 | `https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Surge/PrivacyLite/PrivacyLite.list` |
