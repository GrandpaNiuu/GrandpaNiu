...
|---|---|---|---|---|---|---|---|---|---|
| Module Factory Build | 构建 Release 并同步 Root | 手动 / push | 2026-05-30T21:38:17Z | completed / failure | 需要检查 | build | Validate repository | 89096c5c2ac8 | build_module.py、factory_finalize.py、profile、sources、Root/Release diff |
