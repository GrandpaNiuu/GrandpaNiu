...
- 生成时间：2026-05-31 06:38:46 +0800
- 状态模式：GitHub API 真实状态模式

| Workflow | 用途 | 触发方式 | 最近运行时间 | 最近状态 | 结论 | 失败 Job | 失败 Step | 对应 commit | 失败时优先排查 |
|---|---|---|---|---|---|---|---|---|---|
| Module Factory Build | 构建 Release 并同步 Root | 手动 / push | 2026-05-30T22:37:14Z | completed / success | 正常 | 无 | 无 | 8e6eddddc82e | build_module.py、factory_finalize.py、profile、sources、Root/Release diff |
...
| Repository Health Check | 仓库治理健康检查 | 手动 / 定时 / push | 2026-05-30T22:38:44Z | in_progress / running | 需要检查 | 无 | 无 | a08dbe6e8665 | 缺失治理文件、README 链接、重复脚本、重复 MITM |
