...
| 淘宝 | Body Rewrite, MITM, Rule, Script, URL Rewrite | 明确覆盖 | 高 | Rewrite/Sources/Body-Rewrite.conf<br>Rewrite/Sources/MITM.conf<br>Rewrite/Sources/URL-Rewrite.conf<br>Rules/app-clean.list<br>Rules/direct.list<br>Scripts/app-clean.conf<br>Scripts/app-cleaner-active.conf | 未测 | 未测试 | 首页、搜索、商品详情、购物车、订单页 | 高风险项需手动复测 |
