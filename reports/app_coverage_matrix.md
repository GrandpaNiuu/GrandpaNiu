...
| 高德地图 | Body Rewrite, MITM, Rule, Script, URL Rewrite | 明确覆盖 | 高 | Rewrite/Sources/Body-Rewrite.conf<br>Rewrite/Sources/MITM.conf<br>Rewrite/Sources/URL-Rewrite.conf<br>Rules/reject.list<br>Scripts/app-cleaner-active.conf | 未测 | 未测试 | 首页、搜索、路线规划 | 高风险项需手动复测 |
