...
def main() -> None:
    ...
    commands: list[list[str]] = [
        ...
        [sys.executable, "tools/generate_platform_compatibility_matrix.py"],
        [sys.executable, "tools/generate_protected_traffic_ledger.py"],
        ...
        [sys.executable, "tools/generate_false_positive_review_report.py"],
